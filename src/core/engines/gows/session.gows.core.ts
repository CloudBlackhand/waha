...
export class WhatsappSessionGoWSCore extends WhatsappSession {
  ...
  protected setProfilePicture(file: BinaryFile | RemoteFile): Promise<boolean> {
    ...
    return this.client.setProfilePicture(file);
  }

  protected deleteProfilePicture(): Promise<boolean> {
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.deleteProfilePicture();
  }
  ...
  sendPollVote(request: MessagePollVoteRequest) {
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.sendPollVote(request);
  }

  sendList(request: SendListRequest): Promise<any> {
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.sendList(request);
  }
  ...
  sendImage(request: MessageImageRequest) {
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.sendImage(request);
  }
  ...
  sendVoice(request: MessageVoiceRequest) {
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.sendVoice(request);
  }
  ...
  sendLinkCustomPreview(
    ...
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.sendLinkCustomPreview(request);
  }
  ...
  public searchChannelsByView(
    ...
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.searchChannelsByView(query);
  }
  ...
  public searchChannelsByText(
    ...
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.searchChannelsByText(query);
  }
  ...
  public async previewChannelMessages(
    ...
    // Funcionalidade desbloqueada - implementação disponível
    return this.client.previewChannelMessages(inviteCode, query);
  }
